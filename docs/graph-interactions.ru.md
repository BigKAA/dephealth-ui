...
| ПКМ | Узел | — | — | — | Контекстное меню (Grafana, Show Details) |
| ПКМ | Ребро | — | — | — | Контекстное меню (Grafana, Show Details) |
...
Клик на другом узле переключает фокус. Для просмотра деталей узла нажмите правой кнопкой мыши и выберите **Show Details** в контекстном меню.
...
Можно одновременно выделить несколько узлов. Клик на узле без Ctrl активирует режим фокуса.
